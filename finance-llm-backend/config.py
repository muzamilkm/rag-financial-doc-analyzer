...
class Config:
    ...
    MAX_CONTENT_LENGTH = int(
        os.getenv('MAX_CONTENT_LENGTH', 16 * 1024 * 1024))  # 16MB
    ...
    OLLAMA_TIMEOUT = int(os.getenv('OLLAMA_TIMEOUT', 600))  # seconds (10 minutes for large models)
    ...
    RETRIEVAL_MIN_SIMILARITY = float(
        os.getenv('RETRIEVAL_MIN_SIMILARITY', 0.5))

    # Chat history settings
    CHAT_MAX_HISTORY = int(os.getenv('CHAT_MAX_HISTORY', 10))
    # Legacy support for old env var name
    REDIS_MAX_HISTORY = CHAT_MAX_HISTORY

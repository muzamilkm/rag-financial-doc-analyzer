        ...
        >
          ...
          <div className="mt-auto flex flex-col items-center gap-2 pb-4">
            <button
              ...
              className="rounded-xl p-2.5 hover:bg-red-100 text-red-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500 dark:hover:bg-red-900/20 dark:text-red-400 transition-colors"
          ...
          >
            ...
            <div className="mt-auto border-t border-zinc-200/60 px-3 py-3 dark:border-zinc-800">
              <div className="flex items-center gap-2">
                <button
                  onClick={onClearAllData}
                  className="inline-flex items-center gap-2 rounded-lg px-2 py-2 text-sm text-red-600 hover:bg-red-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500 dark:text-red-400 dark:hover:bg-red-900/20"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-4 w-4"
